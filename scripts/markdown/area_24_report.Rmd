...
library(png)
library(gridExtra)
img1 <-  rasterGrob(as.raster(readPNG(here("maps", "area24", "area24_kennedy1.png"))), interpolate = FALSE)
img2 <-  rasterGrob(as.raster(readPNG(here("maps", "area24", "area24_kennedy2.png"))), interpolate = FALSE)
